...
> 本目录是 `Tracer 2.0` 微服务方案的本地主文档集，按“总体架构 -> 接入层 -> 核心服务 -> 基础设施”组织，作为飞书知识库的本地可维护版本。
...
| `04-core-services/` | Core Service、Prompt Engine、Tool SDK 等编排与能力服务 |
...
4. 然后读 `04-core-services/` 下的核心服务设计文档
5. 最后读 `05-infrastructure/storage-and-deployment.md`
